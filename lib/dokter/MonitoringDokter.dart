...
import 'package:test_bloc_firebase_1/ChatNdnApp/showKontak.dart';
import 'package:test_bloc_firebase_1/dokter/webviewDokter.dart';
import '../webview/WebViewNdn.dart';

class MonitoringPageDokter extends StatefulWidget {
  const MonitoringPageDokter({super.key});

  @override
  State<MonitoringPageDokter> createState() => _MonitoringPageDokterState();
}

class _MonitoringPageDokterState extends State<MonitoringPageDokter> {
                  ...
                  GestureDetector(
                    onTap: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => NdnVebViewDokter()));
                    },
                    child: Container(
                      width: 200,
                      height: 200,
                      decoration: BoxDecoration(
                          image: DecorationImage(
                              image: AssetImage('gambar/monitoring.png'))),
                    ),
                  ),
                ],
              )
